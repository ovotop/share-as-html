...
The script SHALL use the updated CSS from the `share-as-html` skill with fluid typography and centering applied. The JS template (three-state state machine, keyboard navigation, zoom mode) SHALL remain unchanged.
