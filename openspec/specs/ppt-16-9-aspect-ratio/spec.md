# PPT 16:9 Aspect Ratio

## Purpose

Define the proportional content scaling system for PPT mode using a fixed ideal layout size and CSS `transform: scale()`. This ensures content layout is preserved identically across all 16:9 screens, with proportional font scaling, while mobile and DOC mode remain unaffected.
